...
message("-- Looking for Driveworks")
...
find_path(Driveworks_INCLUDE_DIR
  ...
  PATHS ${Driveworks_PKGCONF_INCLUDE_DIRS}/../targets/${CMAKE_SYSTEM_PROCESSOR}-linux/include
...
find_library(Driveworks_LIBRARY
  NAMES driveworks
  PATHS ${Driveworks_PKGCONF_LIBRARY_DIRS}/../targets/${CMAKE_SYSTEM_PROCESSOR}-linux/lib
